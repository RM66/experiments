...
9. [Отчеты] (#9-Отчеты)
  1. [Отправить список целей для генерации отчета] (#91-Отправить-список-целей-для-генерации-отчета-post-reports)
...
### 5.2. Получение истории (объекта) в контексте темы `GET /history/:id/themes/:id`
...
### 10.1. Отправка списка целей для генерации отчета `POST /reports`
