...
5. [История] (#5-История)
  ...
  2. [Получение истории в контексте темы (для объекта)] (#52-Получение-истории-в-контексте-темы-для-объекта-get-historyidthemesid) `GET /history/:id/themes/:id`
6. [Поиск] (#6-Поиск)
...
9. [Отчеты] (#9-Отчеты)
  1. [Отправка списка целей для генерации отчета] (#91-Отправка-списка-целей-для-генерации-отчета-post-reports) `POST /reports`
10. [Статусы] (#10-Статусы)
  1. [Статусы тем] (#101-Статусы-тем)
  2. [Статусы объектов] (#102-Статусы-объектов)
  3. [Статусы испытаний] (#103-Статусы-испытаний)
  4. [Статусы задач] (#104-Статусы-задач)
      ...
      "objects": [
        {
		  ...
		  "status": "Статус составной части1"
        },
        {
          "id": "86956055-6058-426c-b730-7d2c7f963cdc",
          "name": "Составная часть2",
		  "status": "Статус составной части2",
          "objects": [
            {
...
### 5.2. Получение истории в контексте темы (для объекта) `GET /history/:id/themes/:id`
...
### 6.2. Получение всех тем `GET /search/themes`
...
### 9.1. Отправка списка целей для генерации отчета `POST /reports`
